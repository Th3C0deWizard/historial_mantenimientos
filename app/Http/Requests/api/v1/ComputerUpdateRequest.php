...
class ComputerUpdateRequest extends FormRequest
{
    ...
    {
        return [
            'name' => 'string|max:10|min:3|unique:computers,name',
            'brand' => 'string|max:50|min:3',
            'ram' => 'integer|min:2|max:64',
            'cpu' => 'string|max:30|min:3',
            'registered_by' => 'missing',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'registered_by.missing' => 'El usuario que registra el computador no puede ser modificado'
        ];
    }
}
